...
- (void)startAdvertisingAvailability {
    ...
    _advertiserAssistant =
        [[MCAdvertiserAssistant alloc] initWithServiceType:@"doodler-game" discoveryInfo:nil session:_session];
...
- (void)showPeerList {
    ...
    MCBrowserViewController *browserViewController =
        [[MCBrowserViewController alloc] initWithServiceType:@"doodler-game" session:_session];
...
// Finished receiving a resource from remote peer and saved the content in a temporary location - the app is responsible
// for moving the file to a permanent location within its sandbox
- (void)session:(MCSession *)session
